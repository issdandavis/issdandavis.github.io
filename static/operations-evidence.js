  ...
  const researchRecord = (item) => {
    ...
    return record({
      ...
      facts: [
        ...
        ["Reviewed messages", item.reviewed_message_count],
        [
          "Complete topic trees",
          `${text(item.complete_topic_trees)}/${text(item.selected_topic_count)}`,
        ],
        ["Review scope", item.forum_review_scope],
        ["Review method", item.forum_review_method],
        ["Claim policy", item.forum_claim_policy],
